...
export default function RoomAnalytics() {
  ...
  const getRoomStats = () => {
    ...
    const completionRate =
      totalQuizzes > 0
        ? ((totalSubmissions / totalQuizzes / 10) * 100).toFixed(1)
        : 0;
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-slate-500 mt-1">
            Overall performance metrics for this room
          </p>
        </div>
                    ...
                    <tr key={quiz.id} className="hover:bg-slate-50">
                      ...
                      <td className="px-6 py-4">
                        <span className="font-semibold text-slate-900">
                          {avgScore.toFixed(1)} ({avgPercentage.toFixed(1)}%)
                        </span>
                      </td>
                      <td className="px-6 py-4">
